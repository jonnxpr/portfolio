...
- A memoria compartilhada de governanca, templates reutilizaveis e notas de rollout que precisam evoluir fora do historico do site agora possuem repositorio irmao dedicado: `/media/jonathan/Dados2/Documentos/portfolio-governance` (`https://github.com/jonnxpr/portfolio-governance`).
